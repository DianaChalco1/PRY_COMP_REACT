    ...
    <div className="container my-5">
      ...
      <section className="my-5 ">
        ...
        <div className="text-center mb-3">
          <Imagen
            src="https://media.istockphoto.com/id/1164357236/es/foto/desarrollo-de-programadores-que-leen-c%C3%B3digos-inform%C3%A1ticos-desarrollo-de-dise%C3%B1o-de-sitios-web-y.jpg?s=612x612&w=0&k=20&c=bYXBXslxc4awnRQQC7HCsYQEhzsHbmir87OVuD_f0ac="
